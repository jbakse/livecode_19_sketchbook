...
export function banner(...msgs: unknown[]): void {
  // string of * same length as msgs
  const stars = "*".repeat(msgs.join(" ").length);

  console.log(colors.bgBlue(colors.white(stars)));
  console.log(colors.bgBlue(colors.white(msgs.join(" "))));
}
