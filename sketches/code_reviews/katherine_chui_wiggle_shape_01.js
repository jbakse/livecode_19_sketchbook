...
const NOISE_ZOOM = 0.02;
const NOISE_LEVEL = 20;
const ANIMATION_SPEED = .01;
...
function drawShape(shape) {
    const expandedPoints = subdividePoints(shape.points, 50);
...
function subdividePoints(points, density = 10) {
    const newPoints = [];
    ...
    for (let i = 0; i < points.length; i++) {
        ...
        const dotCount = distance / density;
        const stepSize = 1 / (dotCount + 1);
