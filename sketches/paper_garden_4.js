...
var PLANT_COUNT = 50;
// var PLANT_RADIUS = 130;
var PLANT_SPACING = 200;
var PLANT_CULL = 0.5;
...
// var rectangle = new Path.Rectangle(project.activeLayer.bounds);
// rectangle.strokeColor = "#61ACEC";
...
function createVine(center, radius) {
  ...
  for (var i = 0; i < length; i++) {
    ...
    offset_x *= 0.5;
    var circle = createCircle(center + offset_point, radius * 0.4);
...
function createCircleDrawn(center, radius) {
  ...
  dash_path.style = {
    ...
    strokeColor: new Color(0.4, 0.4, 0.4),
